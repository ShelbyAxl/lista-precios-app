...
//FIC: Helpers
// import { CondicioneValues } from "../../helpers/CondicioneValues";
//FIC: Services
// import { AddOneCondicione } from "../../../Condiciones/services/remote/post/AddOneCondicione";
const AddCondicioneModal = ({
  ...
  const [CondicionesValuesLabel, setCondicionesValuesLabel] = useState([]);
  const [Loading, setLoading] = useState(false);

  useEffect(() => {
    getDataSelectCondicionesType();
  }, []);
  ...
  async function getDataSelectCondicionesType() {
    try {
      const Labels = await GetAllLabels();
      console.log("Labels:", Labels); // Registrar la respuesta completa
      const CondicionesTypes = Labels.find(
        (label) => label.IdEtiquetaOK === "IdTipoGiros"
      );
      console.log("CondicionesTypes:", CondicionesTypes); // Registrar el resultado de la búsqueda
      if (CondicionesTypes) {
        setCondicionesValuesLabel(CondicionesTypes.valores);
      } else {
        console.error(
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        >
          ...
          <Select
            ...
            disabled={!!mensajeExitoAlert}
          >
            {CondicionesValuesLabel.map((tipoGiro) => {
              return (
                <MenuItem
